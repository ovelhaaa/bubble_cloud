...
WASM_OUT ?= $(BUILD_DIR)/bubble_cloud_wasm.js
...
$(OFFLINE_RENDERER): platform/offline/sound_bubbles_render.c core/engine/bubble_engine.c core/dsp/sound_bubbles_dsp.c
	mkdir -p $(dir $@)
	$(CC) $^ $(CFLAGS) -o $@
