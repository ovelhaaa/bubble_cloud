...
static const BubblePresetParamSpec_t BUBBLE_PRESET_PARAM_SPECS[] = {
    ...
    { BUBBLE_ENGINE_PARAM_ATTACK_REGION_MIN_OFFSET_SAMPLES, "attack_region_min_offset_samples", 0.0f, (float)(BUBBLES_BUFFER_SIZE_SAMPLES - 1), 441.0f, BUBBLE_PRESET_PARAM_INT },
    { BUBBLE_ENGINE_PARAM_ATTACK_REGION_MAX_OFFSET_SAMPLES, "attack_region_max_offset_samples", 0.0f, (float)(BUBBLES_BUFFER_SIZE_SAMPLES - 1), 3528.0f, BUBBLE_PRESET_PARAM_INT },
    { BUBBLE_ENGINE_PARAM_BODY_REGION_MIN_OFFSET_SAMPLES, "body_region_min_offset_samples", 0.0f, (float)(BUBBLES_BUFFER_SIZE_SAMPLES - 1), 3528.0f, BUBBLE_PRESET_PARAM_INT },
    { BUBBLE_ENGINE_PARAM_BODY_REGION_MAX_OFFSET_SAMPLES, "body_region_max_offset_samples", 0.0f, (float)(BUBBLES_BUFFER_SIZE_SAMPLES - 1), 11025.0f, BUBBLE_PRESET_PARAM_INT },
    { BUBBLE_ENGINE_PARAM_MEMORY_REGION_MIN_OFFSET_SAMPLES, "memory_region_min_offset_samples", 0.0f, (float)(BUBBLES_BUFFER_SIZE_SAMPLES - 1), 11025.0f, BUBBLE_PRESET_PARAM_INT },
    { BUBBLE_ENGINE_PARAM_MEMORY_REGION_MAX_OFFSET_SAMPLES, "memory_region_max_offset_samples", 0.0f, (float)(BUBBLES_BUFFER_SIZE_SAMPLES - 1), 39690.0f, BUBBLE_PRESET_PARAM_INT },
    ...
    { BUBBLE_ENGINE_PARAM_RNG_SEED, "rng_seed", 0.0f, 4294967295.0f, 1.0f, BUBBLE_PRESET_PARAM_INT },
