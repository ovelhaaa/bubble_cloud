...
static const BubblePresetParamSpec_t BUBBLE_PRESET_PARAM_SPECS[] = {
    ...
    { BUBBLE_ENGINE_PARAM_TEMPO_BPM, "tempo_bpm", 20.0f, 300.0f, 120.0f, BUBBLE_PRESET_PARAM_FLOAT },
    { BUBBLE_ENGINE_PARAM_TEMPO_SYNC_ENABLED, "tempo_sync_enabled", 0.0f, 1.0f, 0.0f, BUBBLE_PRESET_PARAM_BOOL },
    { BUBBLE_ENGINE_PARAM_RHYTHM_DIVISION, "rhythm_division", 0.0f, 3.0f, 2.0f, BUBBLE_PRESET_PARAM_ENUM },
    { BUBBLE_ENGINE_PARAM_BURST_MODE, "burst_mode", 0.0f, 4.0f, 0.0f, BUBBLE_PRESET_PARAM_ENUM },
    { BUBBLE_ENGINE_PARAM_RHYTHM_PATTERN, "rhythm_pattern", 0.0f, 4294967295.0f, 4369.0f, BUBBLE_PRESET_PARAM_INT }
};
