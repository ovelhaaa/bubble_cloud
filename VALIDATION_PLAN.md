...
*   **No runaway spawning:** The spawn accumulator never spirals out of control; bounds checks (`SCHED_MAX_SPAWNS_PER_TICK`) and `BUBBLES_PENDING_SPAWN_CAPACITY` hold.
